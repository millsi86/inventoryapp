...
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryapp/items" will map
        // to the integer code {@link #ITEMS}. This URI is used to provide access to MULTIPLE rows
        // of the inventory table.
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_ITEMS, ITEMS);

        // The content URI of the form "content://com.example.android.inventoryapp/items/#" will
        // map to the integer code {@link #Item_ID}. This URI is used to provide access to ONE
        // single row of the inventory table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.android.inventoryapp/items/3" matches, but
        // "content://com.example.android.inventoryapp/items" (without a number at the end)
        // doesn't match.
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoruapp/items/3",
                ...
                // This will perform a query on the inventory table where the _id equals 3 to
